...
function chatbotSendMessage(messageText){
    ...
    "<span style="+"margin-top:10px;font-family:Lucida Sans; padding:10px"+">"+ messageText +"</span>";
...
function initializeOptions(){
    ...
    for(let i=0; i<options.length; i++){
          ...
          "<span style="+"margin-top:10px; font-family:Lucida Sans; padding:10px"+">"+ options[i].number +" - "+ options[i].chocie +"</span>";
